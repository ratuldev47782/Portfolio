...
const baseURL: string = "https://md-ratul.me";

const routes: RoutesConfig = {
  "/": true,
  "/about": true,
  "/work": true,
  // The blog still holds the Once UI template docs; flip this to true once you publish your own posts
  "/blog": false,
  "/gallery": true,
};
